...
//----------------------------------------------------------------------------------------------------------------------------------------------------------------
          ...
          <?php
            ...
            echo '<a class="Button4" href="../mixed.php/?user='.$query_array["user"].'">Redo</a>';
       echo '</fieldset>';
  }
...
<form>
  ...
  <fieldset align="center">
    <legend><strong><p>Mixed Problems</p></strong></legend>
  ...
  <?php
    ...
    if(trim($current_teacher) === "placeholder"){
      ...
      foreach ($plist as $equation) {
        ...
        //only print problem if it has less than 5 appearances.
        $prob_type = $equation['operation'];
