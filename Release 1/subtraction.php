...
<body>
  <?php
  //if we haave submitted something, only show results
        ...
        <fieldset align="center">
          ...
          <?php
            ...
            foreach ($plist as $equation) {
              ...
              //only print problem if it is subtraction
          ...
          <?php
            ...
            echo '<a class="Button4" href="../subtraction.php/?user='.$query_array["user"].'">Redo</a>';
       echo '</fieldset>';
  }
...
<form>
  ...
  <fieldset align="center">
    <legend><strong><p>Subtraction</p></strong></legend>
